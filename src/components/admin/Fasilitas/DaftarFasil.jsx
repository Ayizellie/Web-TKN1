...
const cards = [
    {title:"Guru", count: "12", label:"Guru Terdaftar", bgColor:"bg-[#6FBFF2]", bgOpacity:"bg-opacity-50", icon: <FaUserGraduate className="text-2xl text-[#2471A2]" /> },
